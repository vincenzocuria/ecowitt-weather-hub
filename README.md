# 🌦️ Ecowitt Weather Hub & Live Smart Dashboard
...
- ⚡ **Motore di Allarmi Intelligente con Anti-Spam Cooldown**:
  ...
  - ❄️ **Gelo / Caldo Estremo**: Notifiche su soglie critiche di temperatura.
  - 🌧️ **Nubifragi e Pioggia Intensa**: Monitoraggio del tasso di pioggia orario (mm/h).
...
- ☀️ **Buongiorno Meteo (Daily Digest)**: Notifica mattutina automatica configurabile con riassunto delle minime della notte e previsioni per la giornata.
...
`ash
git clone https://github.com/vincenzocuria/ecowitt-weather-hub.git
...
## ⚙️ Configurazione della Stazione Meteo (Ecowitt / Sainlogic)
